...
st.markdown(
    ...
    .st-cy, .st-cz, .stMarkdown, .stHeader, .stSubheader {
        color: #F0F0F0 !important;  /* Light gray for better readability */
    }
...
# Define survey questions with conditional logic
SURVEY_QUESTIONS = [
    {
    ...
    },
    {
        ...
        "conditional": {
            ...
            "follow_up": {
                "type": "open_ended",
                "question": "Please specify other frameworks you use:",
                "placeholder": "List other frameworks..."
            }
        }
    },
    {
    ...
    },
    {
        ...
        "conditional": {
            ...
            "follow_up": {
                "type": "multiple_choice_multi",
                "question": "What resources are you using to learn Python?",
    ...
    def next_question(self):
        ...
        if not self.is_conditional_question(current_q_ref):
            ...
            if "conditional" in question_data:
                ...
                # For multi-select questions, check if trigger is in answers
                if question_data["type"] == "multiple_choice_multi":
                    should_show_conditional = trigger in answer if answer else False
                else:
